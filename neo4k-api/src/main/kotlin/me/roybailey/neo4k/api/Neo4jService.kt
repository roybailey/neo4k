...
open class Neo4jService(
    ...
    fun isEmbedded(): Boolean = neo4jUri.startsWith("file://")
    ...
    open fun execute(cypher: String, params: Map<String, Any> = emptyMap(), code: Neo4jResultMapper = nullNeo4jResultMapper) {
        graphDb.beginTx().run {
            try {
    ...
    open fun query(cypher: String, params: Map<String, Any> = emptyMap()): List<Map<String, Any>> {
